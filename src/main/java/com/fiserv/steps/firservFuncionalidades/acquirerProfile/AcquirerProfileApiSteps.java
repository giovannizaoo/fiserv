package com.fiserv.steps.firservFuncionalidades.acquirerProfile;
...
public class AcquirerProfileApiSteps {
    ...
    @When("prencho todos os campos obrigatorios do endpoint acquirer profile utilizando o ambiente cat")
    public void prencho_todos_os_campos_obrigatorios_do_endpoint_acquirer_profile_utilizando_o_ambiente_cat() throws Exception {
    ...
    public void prencho_todos_os_campos_obrigatorios_do_endpoint_acquirer_profile_utilizando_o_ambiente_uat() {
    ...
    @Then("a Api do endpoint acquirer profile devera retornar status code {int} com os dados esperados no corpo da resposta")
    public void a_api_do_endpoint_acquirer_profile_devera_retornar_status_code_com_os_dados_esperados_no_corpo_da_resposta(Integer statusCodeEsperado) {

package com.fiserv.steps.firservFuncionalidades.allTerminalValues;
...
public class AllTerminalValuesApiSteps {
    ...
    public void prencho_todos_os_campos_obrigatorios_do_endpoint_all_terminal_values_utilizando_o_ambiente_cat() throws Exception {
        ...
        validarResponse = RestAssured
                ...
                .get("/api/v1/terminal/allTerminalValues") //Verificar Url
                .prettyPeek();
    }

    @When("prencho todos os campos obrigatorios do endpoint all terminal values utilizando o ambiente uat")
    public void prencho_todos_os_campos_obrigatorios_do_endpoint_all_terminal_values_utilizando_o_ambiente_uat() {
    ...
    @Then("a Api do endpoint all terminal values devera retornar status code {int} com os dados esperados no corpo da resposta")
    public void a_api_do_endpoint_all_terminal_values_devera_retornar_status_code_com_os_dados_esperados_no_corpo_da_resposta(Integer statusCodeEsperado) {

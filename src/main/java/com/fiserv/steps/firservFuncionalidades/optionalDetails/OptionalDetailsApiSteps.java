package com.fiserv.steps.firservFuncionalidades.optionalDetails;
...
public class OptionalDetailsApiSteps {
    ...
    public void prencho_todos_os_campos_obrigatorios_do_endpoint_optional_details_utilizando_o_ambiente_cat() throws Exception {
        ...
        validarResponse = RestAssured
                ...
                .get("/api/v1/application/optional-details") //Verificar Url
                .prettyPeek();
    }

    @When("prencho todos os campos obrigatorios do endpoint optional details utilizando o ambiente uat")
    public void prencho_todos_os_campos_obrigatorios_do_endpoint_optional_details_utilizando_o_ambiente_uat() {
    ...
    @Then("a Api do endpoint optional details devera retornar status code {int} com os dados esperados no corpo da resposta")
    public void a_api_do_endpoint_optional_details_devera_retornar_status_code_com_os_dados_esperados_no_corpo_da_resposta(Integer statusCodeEsperado) {
